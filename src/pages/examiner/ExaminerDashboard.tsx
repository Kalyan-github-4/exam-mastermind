...
const ExaminerDashboard: React.FC = () => {
  const { exams, submissions } = useExamContext();
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockStatistics.totalExams}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockStatistics.totalSubmissions}</div>
            <p className="text-xs text-muted-foreground">
              Across all exams
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockStatistics.averageScore.toFixed(1)}%</div>
            <p className="text-xs text-muted-foreground">
              Overall performance
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockStatistics.passRate}%</div>
            <p className="text-xs text-muted-foreground">
              Students passing
            </p>
          </CardContent>
