          ...
          <div className="flex items-center gap-2">
            <Link to="/student">
              <Button 
                variant="outline" 
                size="sm" 
                className="hidden md:flex border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/10"
              >
                Switch to Student
              </Button>
            </Link>
          ...
          <div className="border-t border-primary-foreground/10 md:hidden">
            <nav className="container py-4 flex flex-col gap-2">
              ...
              <Link to="/student" onClick={() => setMobileMenuOpen(false)}>
                <Button 
                  variant="outline" 
                  className="w-full mt-2 border-primary-foreground/20 text-primary-foreground"
                >
                  Switch to Student
                </Button>
              </Link>
